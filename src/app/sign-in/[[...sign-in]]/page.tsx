      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-xl font-light text-text-primary">Welcome back</h1>
          ...
          <SignIn
            appearance={{
              elements: {
                ...
                identityPreview: 'border-neutral-200 rounded-lg',
                identityPreviewEditButton: 'text-black hover:text-neutral-600',
              },
            }}
          />
        </div>
