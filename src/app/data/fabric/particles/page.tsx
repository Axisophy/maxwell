      ...
      <div className="px-2 md:px-4 pt-2 md:pt-4 pb-4 md:pb-8">
        ...
        <div className="bg-[#1d1d1d] rounded-lg p-2 md:p-4 mb-px">
          ...
          <p className="text-xs md:text-base text-white/60 mt-2 max-w-2xl">
            The theoretical framework describing all known fundamental particles and three of the four fundamental forces — our most complete picture of nature at its smallest scales.
          </p>
        </div>
