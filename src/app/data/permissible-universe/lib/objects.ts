...
const FUNDAMENTAL_PARTICLES: CosmicObject[] = [
  {
    ...
    logRadius: -13,
    logMass: -27.04,
    radius: { value: 1, unit: '×10⁻¹³ cm', formatted: '<10⁻¹³ cm (point-like)' },
    ...
    whyThisSize: 'The electron has no measurable size – experiments constrain it to less than 10⁻¹³ cm. Its Compton wavelength (3.86×10⁻¹¹ cm) defines its quantum "fuzziness."',
    explanations: {
      ...
      intuitive: 'The electron is point-like (no measured radius), but its Compton wavelength ℏ/mec ≈ 3.86×10⁻¹¹ cm sets its quantum size. Electric charge e = 1.6×10⁻¹⁹ C.',
    ...
    nearbyObjects: ['proton', 'muon', 'neutrino'],
  ...
  },
  {
    ...
    whyThisSize: 'Like the electron, the muon is point-like. Its existence revealed the second generation of matter.',
    explanations: {
      ...
      technical: 'Muon g-2 anomaly: measured value differs from SM by ~4σ. Possible new physics signal.',
