      ...
      <div className="px-4 md:px-8 lg:px-12 py-12 md:py-24">
        <div className="max-w-3xl">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-black mb-4">The Opportunity</h2>
            ...
            <p className="text-lg text-black/80 leading-relaxed">
              MXWLL follows a proven model: <strong>taste + presentation + trust = value</strong>. Flightradar24 built a billion-dollar business presenting publicly available flight data beautifully. We're applying the same principle to science.
            </p>
          </section>

          {/* What makes us different */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-black mb-4">What Makes Us Different</h2>
            <div className="space-y-4">
              <div>
                <h3 className="font-bold text-black">Design-led approach</h3>
                <p className="text-black/80">We apply product-design thinking to science presentation. Every widget, every page, every interaction is crafted with the care usually reserved for luxury products.</p>
              </div>
              <div>
                <h3 className="font-bold text-black">Curation over aggregation</h3>
                <p className="text-black/80">We're not trying to be comprehensive. We choose the right things and present them exceptionally well.</p>
              </div>
              <div>
                <h3 className="font-bold text-black">Multiple revenue streams</h3>
                <p className="text-black/80">Premium subscriptions, institutional partnerships, educational licensing, and curated advertising — a sustainable model that doesn't compromise user experience.</p>
              </div>
              <div>
                <h3 className="font-bold text-black">Deep content moat</h3>
                <p className="text-black/80">The Vault contains 2,500 years of scientific literature, beautifully formatted. This isn't easily replicated.</p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-black mb-4">Who We're Looking For</h2>
            <p className="text-lg text-black/80 leading-relaxed mb-4">
              We're interested in speaking with:
            </p>
            <ul className="list-disc list-inside text-lg text-black/80 space-y-2 mb-4">
