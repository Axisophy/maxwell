      ...
      <div className="px-2 md:px-4 pt-2 md:pt-4 pb-4 md:pb-8">
        ...
        <div className="bg-white rounded-lg p-2 md:p-4 mb-px">
          ...
          <p className="text-sm md:text-base text-black/60 mt-2 max-w-3xl">
            118 elements arranged by atomic number and electron configuration.
            The table reveals patterns in properties that repeat periodically -
            elements in the same column share chemical behaviours.
          </p>
        </div>
