...
export default function WidgetFrame({
  ...
  return (
    <div className={`flex flex-col gap-px ${className}`}>
      ...
      {/* Title Frame - white */}
      <div className="bg-white rounded-lg px-2 md:px-4 py-2 md:py-3 flex items-center justify-between">
      ...
      {/* Info Frame - black (only when expanded) */}
      {infoOpen && (description || source) && (
        <div className="bg-black rounded-lg p-2 md:p-4">
          {description && (
