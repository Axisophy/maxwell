...
// Design: Dark theme (#0f0f23), cyan accents
// ===========================================
...
export default function CosmicRaysThrough() {
  ...
  return (
    <div ref={containerRef} style={{ fontSize: `${baseFontSize}px` }} className="bg-[#1a1a1e] p-[1em] h-full flex flex-col relative overflow-hidden">
      ...
      <div className="text-center mb-[0.75em] relative z-10">
        <div className="text-[0.5em] text-white/50 uppercase tracking-wider mb-[0.25em]">Muons per minute</div>
        <div className="font-mono text-[2.5em] font-bold text-cyan-400 leading-none">
          ~{formatBigNumber(muonsPerMinute)}
        </div>
        <div className="text-[0.625em] text-white/50">through your body</div>
      </div>
      ...
      <div className="flex-1 relative flex items-center justify-center min-h-0">
        <div className="relative">
          ...
          <svg viewBox="0 0 60 120" className="h-[8em] w-auto opacity-30">
            {/* Head */}
            <ellipse cx="30" cy="14" rx="9" ry="11" fill="white" />
            {/* Neck */}
            <rect x="26" y="24" width="8" height="6" fill="white" />
            {/* Torso */}
            <path d="M20 30 L40 30 L38 65 L22 65 Z" fill="white" />
            {/* Arms */}
            <path d="M20 32 L12 55 L15 56 L22 36" fill="white" />
            <path d="M40 32 L48 55 L45 56 L38 36" fill="white" />
            {/* Legs */}
            <path d="M22 65 L20 100 L26 100 L28 68" fill="white" />
            <path d="M38 65 L40 100 L34 100 L32 68" fill="white" />
          </svg>
      ...
      <div className="grid grid-cols-2 gap-[0.5em] relative z-10 mt-[0.5em]">
        <div className="bg-white/5 rounded-lg p-[0.5em]">
          <div className="text-[0.5em] text-white/50 uppercase tracking-wider">Today</div>
          <div className="font-mono text-[0.875em] text-white font-medium">
            {formatBigNumber(totalToday)}
          </div>
        </div>
        <div className="bg-white/5 rounded-lg p-[0.5em]">
          <div className="text-[0.5em] text-white/50 uppercase tracking-wider">Since Loading</div>
          <div className="font-mono text-[0.875em] text-white font-medium">
      ...
      {/* Explanation */}
      <div className="mt-[0.375em] text-[0.5em] text-white/40 relative z-10">
